...
export default function DigestSignup() {
  ...
  return (
    <div id="digest" className="rounded-2xl bg-cobalt text-white p-5 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        <i className="fa-regular fa-envelope text-blue-200" />
      ...
      {done ? (
        ...
        <>
          <p className="text-sm text-blue-100 leading-relaxed mb-4">
            Get curated insights on freelancing, creator economy, and platform updates. No spam, unsubscribe anytime.
          </p>
