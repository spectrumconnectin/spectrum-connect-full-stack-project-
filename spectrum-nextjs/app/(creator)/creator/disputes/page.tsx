...
const FILTERS = ['all', 'open', 'under_review', 'escalated', 'resolved_creator_favor'] as const;
...
function NewDisputeModal({ onClose, onCreated }: {
  ...
  useEffect(() => {
    escrow.list({ role: 'creator', limit: 50 })
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea rows={3}
              ...
              placeholder="Provide a full explanation of the issue, timeline, and what resolution you seek…"
              value={details}
          ...
          <div className="bg-blue-50 rounded-xl p-4 text-sm text-blue-700">
            ...
            Funds in escrow for this project will be temporarily held during the review.
          </div>
