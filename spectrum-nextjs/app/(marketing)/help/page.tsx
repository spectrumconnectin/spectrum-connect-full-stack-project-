...
const sections = [
  ...
  },
  {
    ...
    faqs: [
      { q: 'How does Smart Connect work?', a: 'Smart Connect looks at your skills, experience, portfolio, and availability to automatically find projects that are a great fit for you. The more complete your profile, the better your matches.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'How do I post a project?', a: 'Go to Post a Project from your dashboard and describe what you need, along with your budget and timeline. Then choose whether to review applications yourself, or let Smart Connect match you with the best creators automatically.' },
